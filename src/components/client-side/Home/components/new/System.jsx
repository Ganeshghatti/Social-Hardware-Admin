...
const System = () => {
  return (
    <section id="system" className="relative flex">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-8 z-10 mt-40 px-20">
        ...
        <div className="relative flex justify-center items-center">
            <div className="absolute -z-10 top-0 left-6 flex flex-col justify-center items-center">
            ...
            <div className="absolute -z-10 top-0 left-26 flex flex-col justify-center items-center">
            ...
            <div className="absolute -z-10 top-0 right-[50px] flex flex-col justify-center items-center">
