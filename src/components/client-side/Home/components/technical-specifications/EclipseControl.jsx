...
const EclipseControl = () => {
  return (
    <section
      id="eclipse-control"
      className="flex w-full flex-col md:flex-row-reverse relative pt-24 py-8 md:py-0 items-center md:justify-center gap-6 md:gap-0 mt-[12git vh] md:h-[75vh] h-auto"
    >
